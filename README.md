...
modified to highlight the principle events
...
Correct some of the more obvious issues with event types. Here we are only
lightly touching the data, fixing the most obvious of event types to correspond
to the permitted list.


```r
# use uppercase to make this easier
